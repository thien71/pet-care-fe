// src/pages/technician/TechnicianSchedule.jsx - LỊCH LÀM VIỆC CỦA KỸ THUẬT VIÊN
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Xem lịch làm việc và công việc được giao</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="stat bg-base-100 shadow rounded-lg p-4">
          <div className="stat-title">Ca tối</div>
          <div className="stat-value text-2xl text-accent">{schedule.filter((s) => s.maCa === 3).length}</div>
        </div>
      </div>
      ...
      <div className="alert alert-info">
        ...
        <span>Bạn sẽ nhận công việc tương ứng với các ca làm được phân công. Hãy kiểm tra thường xuyên!</span>
      </div>
    </div>
  );
};
