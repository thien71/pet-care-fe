// src/pages/technician/TechnicianSchedule.jsx
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <p className="text-gray-600">Xem lịch làm việc và công việc được giao</p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          <span className="font-semibold">Lưu ý:</span> Bạn sẽ nhận công việc tương ứng với các ca làm được phân công. Hãy kiểm tra thường
          xuyên!
        </p>
      </div>
    </div>
