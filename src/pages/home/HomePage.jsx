        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-6">
              {["Tắm rửa", "Cắt tỉa", "Khám sức khỏe", "Tiêm chủng"].map(
                (tag) => (
                  <button
                    key={tag}
                    onClick={() => {
                  ...
                  {visibleServices.map((service) => (
                    ...
                    >
                      ...
                      <div className="px-5 pt-5 pb-3">
                        <h3 className="font-bold text-lg text-gray-900 line-clamp-2 mb-3 transition">
                          {service.tenDichVu}
                        </h3>
        ...
        <section className="py-20 bg-linear-to-b from-white to-orange-50">
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">
                Được khách hàng tin tưởng nhất
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {topShops.map((shop) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-[#8e2800] transition">
                      {shop.tenCuaHang}
                    </h3>
