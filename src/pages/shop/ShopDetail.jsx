        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <h1 className="text-3xl font-bold text-gray-900 mb-4">{shop.tenCuaHang}</h1>

              <div className="space-y-3 mb-6">
                {shop.diaChi && (
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-[#8e2800] shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
                ...
                {shop.soDienThoai && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900 mb-1">Số điện thoại</p>
              ...
              {shop.moTa && (
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h3 className="text-sm font-semibold text-gray-900 mb-2">Giới thiệu</h3>
          ...
          services.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((service) => {
                ...
                return (
                  <ServiceCard key={service.maDichVuShop} service={serviceData} onClick={() => handleServiceClick(service.maDichVuShop)} />
                );
              })}
            </div>
          ) : (
