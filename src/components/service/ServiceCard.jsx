  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden bg-gray-100">
        ...
        {/* Price Badge */}
        <div className="absolute top-3 right-3 bg-[#8e2800] text-white px-3 py-1 rounded-full text-sm font-bold shadow-md">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
          {reviewCount > 0 ? (
            <div className="flex items-center gap-1">
              ...
              <span className="font-semibold text-gray-900 text-sm">{parseFloat(rating).toFixed(1)}</span>
